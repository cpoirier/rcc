 ...
 #  - "replaces" the top-of-stack Position
   ...
   class AttemptPosition < PositionMarker
    ...
    #---------------------------------------------------------------------------------------------------------------------
      ...
      def initialize( context, node, state, lexer, stream_position, launch_action, expected_productions, attempt_depth = 0 )
         super( context, node, state, lexer, stream_position )
